...
class EFIWindow(Gtk.Window):
    def __init__(self):
        ...
        shutdown_bnt = btn_with_icon("system-shutdown-symbolic")
        reboot_bnt = btn_with_icon("system-restart-symbolic")
        ...
        shutdown_bnt.set_tooltip_text("shutdown")
        reboot_bnt.set_tooltip_text("reboot")

        hbox.add(shutdown_bnt)
        hbox.add(reboot_bnt)
        hbox.add(up)
        hbox.add(down)
        hbox.add(new)
        ...
        shutdown_bnt.connect("button-press-event", self.shutdown)
        reboot_bnt.connect("button-press-event", self.reboot)
